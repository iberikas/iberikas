...
const char * const BITCOIN_CONF_FILENAME = "iberikas.conf";
const char * const BITCOIN_PID_FILENAME = "iberikas.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "IberiKas";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/IberiKas";
#else
    // Unix
    return pathRet / ".iberikas";
#endif
#endif
}
