...
{
    const char* pszTimestamp = "EL PAIS 21/Mar/2022 El desafío medioambiental de las criptomonedas";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1647890283, 2084919768, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7f42983c8690f364afa2375ffead130d2e246be21a6a707ddbb4353f7e335896"));
        assert(genesis.hashMerkleRoot == uint256S("0x087fb5a18c9782d8479086eae8b935d1511b5f75ec8ff38ad03d3b05c4c5f6b1"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("54.166.22.39", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.iberikastools.com", true);
        vSeeds.emplace_back("seed-b.iberikas.loshan.co.uk", true);
...
public:
    CRegTestParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0x7f42983c8690f364afa2375ffead130d2e246be21a6a707ddbb4353f7e335896")},
            }
        };
