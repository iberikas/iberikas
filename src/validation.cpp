...
#if defined(NDEBUG)
# error "IberiKas cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "IberiKas Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s IBK additional fees, %d delta bytes\n",
