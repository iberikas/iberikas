...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s iberikas-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  iberikas-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded iberikas transaction") + "\n" +
              "  iberikas-tx [options] -create [commands]   " + _("Create hex-encoded iberikas transaction") + "\n" +
              "\n";
