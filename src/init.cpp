...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/iberikas-project/iberikas>";
    const std::string URL_WEBSITE = "<https://iberikas.org>";
